...
<nav x-data="{ open: false }" class="bg-surface border-b border-line shadow-sm">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" wire:navigate class="flex items-center gap-2">
                        ...
                        <span class="font-semibold text-navy tracking-tight">{{ config('app.name', 'Sistema RRHH') }}</span>
                    </a>
                </div>
